    ...
    <div class="game">
        ...
        <div class="board">
            ...
            <ul v-show="getGameStatus" class="cards">
                <app-card
                        v-for="(card, index) in getCards" :key="index"
        ...
        <div class="controls">
            <div v-show="!getGameStatus" class="stat-bar">
                <button 
                    @click="startGame"
                    class="button button-new-game">Play!</button>
            ...
            <div v-show="getGameStatus" class="stat-bar">
                ...
                <button 
                    @click="endGame"
                    class="button">Quit</button>
                <div style="display: inline-block; font-size: x-large; margin-left: 10px;">
                    Score: {{ getScore }} | 
                    Sets: {{ numberSets }} |
                    <appTimer></appTimer>
...
export default {
    ...
    methods: {
        ...
        checkIfSet: function() {
            ...
            if (this.isSet) {
                // Set
                this.displayMessage(setMessages[Math.floor(Math.random() * setMessages.length)]);
                this.updateScore(20);
                this.replaceSet();
                this.clearSelected();
            } else {
